public class PatientQueue
{
   ...
   public PatientQueue()
   {
      ...
      queue = new Patient[this.arraySize];
   ...
   public void enqueue (Patient patient)
   {
      ...
      {
         System.out.println("The queue is full. No more patients can be added.");
      }
      else 
      {
         queue[rear] = patient; // putting the passed parameter in the rear of our queue
         ...
         System.out.println("Added " + patient.getName() + " to the queue. It is at: " + rear); 
      }
   }
   ...
   public Patient popPriority()
   {
    ...
    public void displayQueue() 
    {
        ...
        {
            System.out.println("Name: " + queue[i].getName() + ", Injury: " + queue[i].getInjury() + ", Priority: " + queue[i].getPriority());
        }
    }
